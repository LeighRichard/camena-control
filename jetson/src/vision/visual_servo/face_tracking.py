...
try:
    ...
    from src.vision.detector import TargetInfo
    from src.vision.face_recognition import FaceRecognizer, FaceInfo
    from src.vision.processor import PositionAdjustment
    from src.camera.controller import ImagePair
...
class FaceTrackingMixin:
    ...
    def _face_to_target_info(self, face: FaceInfo) -> TargetInfo:
        ...
        return TargetInfo(
            ...
            bounding_box=(x, y, x + w, y + h),  # 修正: 使用 bounding_box 而不是 bbox
